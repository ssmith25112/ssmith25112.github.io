...
var Classes = function Classes() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(PageTitle, {
    ...
    shrink: true,
    body: classes
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Card2, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "card-body"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Mindful Eating: Holiday Edition!"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "This 1.5 hour class is designed to provide an introduction to the skills needed to healthfully navigate the food obstacle course this holiday season!  Change is possible. We can lay the groundwork today for a much healthier, happier, and liberated tomorrow."), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Class will cover managing cravings, setting loving limits (with self and others!), and how to enjoy food without overdoing it. By the end of the evening participants will be prepared to explore a new relationship with food; one where shame and guilt have no place."), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "If you've ever wondered if there was a way to get through the season without stressing about holiday eating, this is your time to find out!"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Register Below!")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ActiveClasses, null)));
};
